#!/usr/bin/env python3
"""
train_kmeans_underground.py - K-Means Clustering for Underground Sensors
Entrena un modelo K-Means con datos de sensores subterráneos
Features: moisture_mean, temperature_mean, ph_mean
"""
...
def main():
    try:
        ...
        emit_progress(5, "Iniciando entrenamiento de K-Means para Underground...")
        ...
        # 🔥 CAMBIO IMPORTANTE: usar porSensor, no "data"
        if not data or "porSensor" not in data:
        ...
        df = pd.DataFrame(data["porSensor"])

        # Validar columnas
        required_cols = ["distance_mean"]  # Solo tienes distancia, no moisture/temperature/ph
